...
-- Mobile-compatible optimization menu
...
local function createMenu()
    ...
    for index, name in ipairs(presetNames) do
        ...
        button.Size = UDim2.new(1 / #presetNames, -8, 1, -10)
        ...
        button.BackgroundColor3 = Color3.fromRGB(93, 120, 255)
    ...
    applyButton.Size = UDim2.new(0.58, 0, 1, 0)
    ...
    resetButton.Size = UDim2.new(0.42, 0, 1, 0)
    resetButton.Position = UDim2.new(0.58, 0, 0, 0)
...
print("Galaxy's Optimisation loaded. Use the OPT button to hide or show the menu.")